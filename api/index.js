...
wsServer.on('request', request => {
  ...
  console.log(`${new Date()} New Client connected as ${client.id} name: ${client.name}, total client count: ${sessionManager.totalConnectedClientCount}  -  active client count: ${sessionManager.activeClientCount}`)
  ...
  connection.on('close', _ => {
    ...
    console.log(`${new Date()} New Client *disconnected as ${client.id} name: ${client.name}, total client count: ${sessionManager.totalConnectedClientCount}  -  active client count: ${sessionManager.activeClientCount}`)
